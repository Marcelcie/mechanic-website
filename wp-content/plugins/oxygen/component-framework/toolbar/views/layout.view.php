	...
	<div class='oxygen-control-wrapper'>
		<div class='oxygen-control'>
			<div class='oxygen-four-sides-measure-box oxygen-four-sides-measure-box-position oxygen-four-sides-measure-box-labels'>
				...
				<?php $this->measure_box('top','',true,true,"model,change,keypress","show_indicator"); ?>
				<?php $this->measure_box('left','',true,true,"model,change,keypress","show_indicator"); ?>
				<?php $this->measure_box('right','',true,true,"model,change,keypress","show_indicator"); ?>
				<?php $this->measure_box('bottom','',true,true,"model,change,keypress","show_indicator"); ?>
