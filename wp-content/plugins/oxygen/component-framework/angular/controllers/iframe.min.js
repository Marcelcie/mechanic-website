...
CTFrontendBuilder.controller("ControllerShortcuts",["$scope","$parentScope","$timeout","$interval","$rootScope",function(e,o,t,a,n){var r,c,i,s=(r=function(e){if("true"==CtBuilderAjax.userCanFullAccess&&!e.originalEvent.repeat&&!o.isActiveActionTab("contentEditing")){var t=!1,a=e.key.toLowerCase();if(e.keyCode,e.ctrlKey||e.metaKey)switch(a){case"s":iframeScope.savePage(),t=!0;break;case"backspace":case"delete":iframeScope.removeActiveComponent(),t=!0;break;case"d":iframeScope.duplicateComponent(),t=!0;break;case"c":n.$broadcast("copyElement"),t=!0;break;case"v":n.$broadcast("pasteElement"),t=!0;break;case"z":iframeScope.undo();break;case"y":iframeScope.redo()}return!t&&void 0}},c=250,function(){var e=this,t=arguments;i&&clearTimeout(i),i=setTimeout(function(){i=null,r.apply(e,t)},c)});function l(e){if(["s","backspace","delete","d","c","v","z","y"].includes(e.key.toLowerCase())&&!(e.target.parentElement.classList.contains("textarea")&&"s"!=e.key.toLowerCase()||"INPUT"==e.target.nodeName&&"s"!=e.key.toLowerCase()||"TEXTAREA"==e.target.nodeName&&"s"!=e.key.toLowerCase()||o.isActiveActionTab("contentEditing")))return e.ctrlKey||e.metaKey?(s(e),!1):void 0}angular.element("body").on("keydown",l),parent.angular.element("body").on("keydown",l)}]);
